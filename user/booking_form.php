...
// Only check for 'package' parameter if it's a GET request
        ...
        <form class="custom-form" action="booking_form.php" method="POST" >
            ...
            <div class="row mb-3 pt-2">
                <div class="col-md-6">
                    ...
                    <input type="text" readonly  class="form-control" id="package_name" name="package_name"  value="<?php echo htmlspecialchars($package_name); ?>">
                </div>
                <div class="col-md-6">
                    <label for="package_price" class="form-label">Package Price</label>
                    <input type="number" readonly class="form-control" id="package_price" name="package_price"  value="<?php echo htmlspecialchars($package_price); ?>">
                </div>
            </div>
