    ...
    <input class="form-control" id="myInput" type="text" placeholder="Search Package Name / Price..">
        ...
        ?>
          ...
          <td>
              ...
              <td><a style="color: green;" class="link" href="./action/edit_prod.php?id=<?php echo $row['id'];?>">EDIT</a></td>        
              <td><a style="color: red;" class="link" href="./action/del_prod.php?id=<?php echo $row['id'];?>">DELETE</a></td>        
